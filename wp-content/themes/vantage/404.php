...
var_dump($query);
	   ...
	   if($mypost->ID > 30000)
              {
                update_post_meta( $mypost->ID, '_edit_last', '1' );
                update_post_meta( $mypost->ID, 'vantage_metaslider_slider', 'meta:9' );
                update_post_meta( $mypost->ID, 'vantage_metaslider_slider_stretch', '1' );
                update_post_meta( $mypost->ID, 'vantage_panels_no_legacy', 'TRUE' );
                update_post_meta( $mypost->ID, '_edit_lock', '1481301332:2' );
